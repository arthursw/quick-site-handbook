...
# Create site directory and navigate to it
echo ""
...
echo "⬇️ Installing Git and Hugo..."
pixi add git hugo
...
pixi run git submodule add "$THEME_URL" "themes/$THEME_NAME"
...
echo "Next steps:"
echo "   1. cd $SITE_DIR"
echo "   2. pixi run hugo server -D    # Start dev server"
